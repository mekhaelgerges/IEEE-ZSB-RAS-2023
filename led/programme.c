...
u8 DIO_u8SetPinDirection        (u8 copy_u8portID,u8 copy_u8pinID,u8 copy_u8pinDirection)
{
	...
	if ((copy_u8portID<=DIO_u8_PORTD )&&(copy_u8pinID <=DIO_u8_PIN7 )&&((copy_u8pinDirection>=DIO_u8_OUTPUT)||(copy_u8pinDirection<=DIO_u8_INPUT)))
	{
		switch(copy_u8portID)
		{
			...
			{
			case DIO_u8_OUTPUT:SET_BIT(DIO_u8_DDRA_REG,copy_u8pinDirection); break;
			case DIO_u8_INPUT:CLR_BIT(DIO_u8_DDRA_REG,copy_u8pinDirection); break;
			}break;
			case DIO_u8_PORTB:
			switch(copy_u8pinDirection)
			{
			case DIO_u8_OUTPUT:SET_BIT(DIO_u8_DDRB_REG,copy_u8pinDirection); break;
			case DIO_u8_INPUT:CLR_BIT(DIO_u8_DDRB_REG,copy_u8pinDirection); break;
			}break;
			case DIO_u8_PORTC:
			switch(copy_u8pinDirection)
			{
			case DIO_u8_OUTPUT:SET_BIT(DIO_u8_DDRC_REG,copy_u8pinDirection); break;
			case DIO_u8_INPUT:CLR_BIT(DIO_u8_DDRC_REG,copy_u8pinDirection); break;
			}break;
			case DIO_u8_PORTD:
			switch(copy_u8pinDirection)
			{
			case DIO_u8_OUTPUT:SET_BIT(DIO_u8_DDRD_REG,copy_u8pinDirection); break;
			case DIO_u8_INPUT:CLR_BIT(DIO_u8_DDRD_REG,copy_u8pinDirection); break;
		}
		break;
	}
	}
...
u8 DIO_u8SetpinVale             (u8 copy_u8portID,u8 copy_u8pinID,u8 copy_u8pinValue)
{
    ...
    case DIO_u8_PORTA:
        ...
        {
            case DIO_u8_HIGH:SET_BIT(DIO_u8_PORTA_REG,copy_u8pinValue);break;
            case DIO_u8_LOW :CLR_BIT(DIO_u8_PORTA_REG,copy_u8pinValue);break;
        ...
        switch(copy_u8pinValue)
        {
            case DIO_u8_HIGH:SET_BIT(DIO_u8_PORTB_REG,copy_u8pinValue);break;
            case DIO_u8_LOW :CLR_BIT(DIO_u8_PORTB_REG,copy_u8pinValue);break;
            default :Local_u8ErrorState=STD_TYBES_NOK;
        }break;
        case DIO_u8_PORTC:
        switch(copy_u8pinValue)
        {
            case DIO_u8_HIGH:SET_BIT(DIO_u8_PORTC_REG,copy_u8pinValue);break;
            case DIO_u8_LOW :CLR_BIT(DIO_u8_PORTC_REG,copy_u8pinValue);break;
            default :Local_u8ErrorState=STD_TYBES_NOK;
        }break;
        case DIO_u8_PORTD:
        switch(copy_u8pinValue)
        {
            case DIO_u8_HIGH:SET_BIT(DIO_u8_PORTD_REG,copy_u8pinValue);break;
            case DIO_u8_LOW :CLR_BIT(DIO_u8_PORTD_REG,copy_u8pinValue);break;
            default :Local_u8ErrorState=STD_TYBES_NOK;
        }break;
    default:Local_u8ErrorState=STD_TYBES_NOK;}
...
u8 DIO_u8GetPinVale             (u8 copy_u8portID,u8 copy_u8pinID,u8 * copy_pu8Returnedpinvalue)
{
   u8 Local_u8ErrorState=STD_TYBES_OK;
    u8 local_pinvalue;
   ...
   if(local_pinvalue=0)
   {
    ...
    else
    {
       ...
       break;
    case DIO_u8_PORTB:local_pinvalue=GET_BIT(DIO_u8_PINA_REG,copy_u8pinID);
   if(local_pinvalue=0)
   {
     * copy_pu8Returnedpinvalue   =DIO_u8_LOW;
    }
    ...
    case DIO_u8_PORTC:local_pinvalue=GET_BIT(DIO_u8_PINA_REG,copy_u8pinID);
   if(local_pinvalue=0)
   {
     * copy_pu8Returnedpinvalue   =DIO_u8_LOW;
    }
    ...
    case DIO_u8_PORTD:local_pinvalue=GET_BIT(DIO_u8_PINA_REG,copy_u8pinID);
   if(local_pinvalue=0)
   {
     * copy_pu8Returnedpinvalue   =DIO_u8_LOW;
    }
